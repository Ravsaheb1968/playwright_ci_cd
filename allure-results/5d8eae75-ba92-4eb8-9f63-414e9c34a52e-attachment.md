...
- Location: tests\demoshoplogin.spec.js:15:5

# Error details

```
ReferenceError: loginlink is not defined
```
            ...
            - generic [ref=e179]:
              - heading "14.1-inch Laptop" [level=2] [ref=e180]:
                - link "14.1-inch Laptop" [ref=e181] [cursor=pointer]:
                  - /url: /141-inch-laptop
              - generic "1574 review(s)" [ref=e182]
              - generic [ref=e185]:
...
```ts
  ...
  17 | 
> 18 |        await this.click(loginlink);
     |                         ^ ReferenceError: loginlink is not defined
  19 |        await this.fill(this.username,Email);
  20 |        await this.password.fill(pass);
