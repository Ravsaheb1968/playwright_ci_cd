...
- Name: endtoend.spec.js >> End to flow Login to Remove Cart  >> Login to Add to Cart ankit80.gupta80@testmail.com 
...
Call log:
  - waiting for getByRole('textbox', { name: 'Email' })
    ...
    - fill("ankit80.gupta80@testmail.com")
      ...
      - list [ref=e10]:
        - listitem [ref=e11]:
          - link "Register" [ref=e12] [cursor=pointer]:
            - /url: /register
        - listitem [ref=e13]:
          - link "Log in" [active] [ref=e14] [cursor=pointer]:
            - /url: /login
        - listitem [ref=e15]:
