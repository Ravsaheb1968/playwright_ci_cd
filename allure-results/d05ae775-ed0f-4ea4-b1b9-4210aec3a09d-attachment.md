...
- Name: endtoend.spec.js >> End to flow Login to Remove Cart  >> Login to Add to Cart neha15.patil15@testmail.com 
...
Call log:
  - waiting for getByRole('textbox', { name: 'Password' })
    - locator resolved to <input id="Password" name="Password" type="password" class="password"/>
    - fill("Test@1015")
