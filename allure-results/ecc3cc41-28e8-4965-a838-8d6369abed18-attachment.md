...
```
Error: locator.click: Error: strict mode violation: getByText('Shopping cart') resolved to 3 elements:
    1) <span class="cart-label">Shopping cart</span> aka getByRole('link', { name: 'Shopping cart (0)' })
    2) <div class="count">↵You have no items in your shopping cart.        </div> aka getByText('You have no items in your')
    3) <a href="/cart" class="ico-cart">Shopping cart</a> aka getByRole('link', { name: 'Shopping cart', exact: true })
                ...
                - generic [ref=e116]:
                  - heading "Computing and Internet" [level=2] [ref=e117]:
                    - link "Computing and Internet" [ref=e118] [cursor=pointer]:
                      - /url: /computing-and-internet
                  - generic "2073 review(s)" [ref=e119]
                  - generic [ref=e122]:
                    - generic [ref=e123]:
